 ...
 * \f$x + 1\f$
 */
#define EPILEPSY_UIntInc(x) desugar(EPILEPSY_UIntInc, x)

/**
 * \f$x - 1\f$
 */
#define EPILEPSY_UIntDec(x) desugar(EPILEPSY_UIntDec, x)

/**
 * \f$x = y\f$
 */
#define EPILEPSY_UIntEq(x, y) desugar(EPILEPSY_UIntEq, x y)

/**
 * \f$x \neq y\f$
 */
#define EPILEPSY_UIntNeq(x, y) desugar(EPILEPSY_UIntNeq, x y)

/**
 * \f$x > y\f$
 */
#define EPILEPSY_UIntGreater(x, y) desugar(EPILEPSY_UIntGreater, x y)

/**
 * \f$x \geq y\f$
 */
#define EPILEPSY_UIntGreaterEq(x, y) desugar(EPILEPSY_UIntGreaterEq, x y)

/**
 * \f$x < y\f$
 */
#define EPILEPSY_UIntLesser(x, y) desugar(EPILEPSY_UIntLesser, x y)

/**
 * \f$x \leq y\f$
 */
#define EPILEPSY_UIntLesserEq(x, y) desugar(EPILEPSY_UIntLesserEq, x y)

/**
 * \f$x + y\f$
 */
#define EPILEPSY_UIntAdd(x, y) desugar(EPILEPSY_UIntAdd, x y)

/**
 * \f$x_1 + \ldots + x_n\f$
 */
#define EPILEPSY_UIntAddVariadics(...) desugar(EPILEPSY_UIntAddVariadics, __VA_ARGS__)

/**
 * \f$x - y\f$
 */
#define EPILEPSY_UIntSub(x, y) desugar(EPILEPSY_UIntSub, x y)

/**
 * \f$x_1 - \ldots - x_n\f$
 */
#define EPILEPSY_UIntSubVariadics(...) desugar(EPILEPSY_UIntSubVariadics, __VA_ARGS__)

/**
 * \f$x * y\f$
 */
#define EPILEPSY_UIntMul(x, y) desugar(EPILEPSY_UIntMul, x y)

/**
 * \f$x_1 * \ldots * x_n\f$
 */
#define EPILEPSY_UIntMulVariadics(...) desugar(EPILEPSY_UIntMulVariadics, __VA_ARGS__)
// }
