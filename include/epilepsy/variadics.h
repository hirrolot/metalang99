 ...
 */
#define EPILEPSY_VARIADICS_COUNT(...) desugar(EPILEPSY_VARIADICS_COUNT, __VA_ARGS__)

/**
 * Extracts a head of its arguments.
 */
#define EPILEPSY_VARIADICS_HEAD(...) desugar(EPILEPSY_VARIADICS_HEAD, __VA_ARGS__)

/**
 * Extracts a tail of its arguments.
 */
#define EPILEPSY_VARIADICS_TAIL(...) desugar(EPILEPSY_VARIADICS_TAIL, __VA_ARGS__)
// }
