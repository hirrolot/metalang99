...
#define MACROLOP_PRIVATE_EVAL_ACC_EMPTY() ()
#define MACROLOP_PRIVATE_EVAL_ACC_EXTEND(acc, ...)                                                 \
    (MACROLOP_PRIVATE_EVAL_AUX_UNPARENTHESISE(acc) __VA_ARGS__)

#define MACROLOP_PRIVATE_EVAL_ACC_CONTINUE(hook, k, k_cx, acc, tail)                               \
    MACROLOP_PRIVATE_EVAL_REC_CONTINUE(                                                            \
        hook, (k, k_cx), acc, MACROLOP_PRIVATE_EVAL_AUX_UNPARENTHESISE(tail))

#define MACROLOP_PRIVATE_EVAL_ACC_END(k, k_cx, acc)                                                \
