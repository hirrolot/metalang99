...
#define KOSHMAR_PP_NOT(x)          KOSHMAR_PP_PRIVATE_BOOL_OVERLOAD_1(KOSHMAR_PP_PRIVATE_NOT_, x)
#define KOSHMAR_PP_PRIVATE_NOT_0() 1
#define KOSHMAR_PP_PRIVATE_NOT_1() 0

#define KOSHMAR_PP_AND(x, y)        KOSHMAR_PP_PRIVATE_BOOL_OVERLOAD_2(KOSHMAR_PP_PRIVATE_AND_, x, y)
...
#define KOSHMAR_PP_OR(x, y)        KOSHMAR_PP_PRIVATE_BOOL_OVERLOAD_2(KOSHMAR_PP_PRIVATE_OR_, x, y)
...
#define KOSHMAR_PP_XOR(x, y)        KOSHMAR_PP_PRIVATE_BOOL_OVERLOAD_2(KOSHMAR_PP_PRIVATE_XOR_, x, y)
