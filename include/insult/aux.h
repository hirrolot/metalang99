 ...
 */
#define INSULT_CAT(x, y) call(INSULT_CAT_REAL, x y)

/**
 * @brief Stringifies @p x.
 */
#define INSULT_STRINGIFY(x) call(INSULT_STRINGIFY_REAL, x)

/**
 * @brief Expands to nothing.
 */
#define INSULT_EMPTY() call(INSULT_EMPTY_REAL, )

/**
 * @brief Expands to @p x.
 */
#define INSULT_ID(x) call(INSULT_ID_REAL, )

/**
 * @brief Expands to the provided arguments.
 */
#define INSULT_EXPAND(...) call(INSULT_EXPAND_REAL, __VA_ARGS__)

/**
 * @brief Expands to nothing, consuming all the provided arguments.
 */
#define INSULT_CONSUME(...) call(INSULT_CONSUME_REAL, __VA_ARGS__)

/**
 * @brief Puts the specified arguments into parentheses.
 */
#define INSULT_PARENTHESISE(...) call(INSULT_PARENTHESISE_REAL, __VA_ARGS__)

/**
 * @brief Removes parentheses around @p x.
 */
#define INSULT_UNPARENTHESISE(x) call(INSULT_UNPARENTHESISE_REAL, x)
...
#define INSULT_UNPARENTHESISE_REAL(x)                                                              \
    call(INSULT_UNPARENTHESISE_REAL_EXPAND_1, INSULT_UNPARENTHESISE_REAL_EXPAND_0 x)
