 ...
 */
#define call(op, ...) INSULT_PRIVATE_call(op, __VA_ARGS__)
...
#define INSULT_PRIVATE_EVAL_TERM_TRANSFORM_TRIVIAL_OP_CALL(op, ...) (call, op, __VA_ARGS__)
