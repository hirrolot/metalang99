 ...
 */
#define INSULT_UINT_INC(x) c(INSULT_UINT_INC_REAL, x)

/**
 * @brief Decrements @p x.
 */
#define INSULT_UINT_DEC(x) c(INSULT_UINT_DEC_REAL, x)

/**
 * @brief Checks whether @p x and @p y are equal.
 */
#define INSULT_UINT_EQ(x, y) c(INSULT_UINT_EQ_REAL, x y)

/**
 * @brief Checks whether @p x and @p y are **not** equal.
 */
#define INSULT_UINT_NEQ(x, y) c(INSULT_UINT_NEQ_REAL, x y)

/**
 * @brief Checks whether @p x is greater than @p y.
 */
#define INSULT_UINT_GREATER(x, y) c(INSULT_UINT_GREATER_REAL, x y)

/**
 * @brief Checks whether @p x is greater or equal than @p y.
 */
#define INSULT_UINT_GREATER_EQUAL(x, y) c(INSULT_UINT_GREATER_EQUAL_REAL, x y)

/**
 * @brief Checks whether @p x is lesser than @p y.
 */
#define INSULT_UINT_LESSER(x, y) c(INSULT_UINT_LESSER_REAL, x y)

/**
 * @brief Checks whether @p x is lesser or equal than @p y.
 */
#define INSULT_UINT_LESSER_EQUAL(x, y) c(INSULT_UINT_LESSER_EQUAL_REAL, x y)
