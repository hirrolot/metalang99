...
Macros provide the means to abstract frequently occurring syntactical structures to let us, programmers, concentrate on the essence of a problem. However, metaprogramming in C is utterly castrated: we cannot even operate with control flow, integers, and unbounded sequences, thereby throwing a lot of hypothetically useful metaprograms out of scope.
