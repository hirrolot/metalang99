...
To solve the problem, I have implemented Metalang99. Having its functionality at our disposal, we can achieve something like this (sum types via [Datatype99]):
