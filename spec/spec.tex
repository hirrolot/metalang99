...
\begin{figure}
    ...
    \begin{align*}
        ...
        (error): & \ \langle K; F; A; \texttt{EPILEPSY\_FATAL}(ident, \overline{tok}) \ \overline{t} \rangle \to halt(\ldots) \\
...
\begin{itemize}
    ...
    \item $(dbg)$ and $(error)$ The ellipsis means that an implementation is free to provide
