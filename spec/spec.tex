...
\begin{figure}
    ...
    \begin{align*}
        ...
        (op): & \ \langle K; F; A; \texttt{METALANG99\_call}(t, \overline{a}), \overline{t'} \rangle \to \langle \\
            & \ \ \ \ \langle K; F; A; \texttt{METALANG99\_call}(?), \overline{t'} \rangle; \\
            & \ \ \ \ fcomma; \\
            & \ \ \ \ (); \\
            & \ \ \ \ t, \overline{a} \rangle \\
...
\begin{itemize}
    ...
    \item With the current implementation, at most $2^{15}$ reduction steps are
