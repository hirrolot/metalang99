...
M_assertEq(M_variadicsCount(v(~) v(~)), v(2));
M_assertEq(M_variadicsCount(v(~) v(~) v(~)), v(3));
M_assertEq(M_variadicsCount(v(~) v(~) v(~) v(~)), v(4));
M_assertEq(M_variadicsCount(_5_ARGS), v(5));
M_assertEq(M_variadicsCount(_5_ARGS v(~)), v(6));
M_assertEq(M_variadicsCount(_5_ARGS v(~) v(~)), v(7));
M_assertEq(M_variadicsCount(_5_ARGS v(~) v(~) v(~)), v(8));
M_assertEq(M_variadicsCount(_5_ARGS v(~) v(~) v(~) v(~)), v(9));
...
M_assertEq(M_variadicsCount(_100_ARGS _50_ARGS v(~) v(~)), v(152));
