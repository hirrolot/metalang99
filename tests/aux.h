...
EPILEPSY_PLAIN_STATIC_ASSERT(sizeof(stringified) >= 5 + 1);
...
EPILEPSY_EVAL(ASSERT_PARENTHESISE EPILEPSY_EVAL(call(EPILEPSY_PARENTHESISE, v(1) v(2) v(3))))

enum {
    EPILEPSY_EVAL(
        call(EPILEPSY_UNPARENTHESISE,
...
#define EMPTY EPILEPSY_EVAL(call(EPILEPSY_UNPARENTHESISE, call(EPILEPSY_PARENTHESISE, )))
CHECK_EMPTY(1, EMPTY)
#undef EMPTY
