...
EPILEPSY_ASSERT_EQ(EPILEPSY_UIntAdd(v(0)), v(0));
EPILEPSY_ASSERT_EQ(EPILEPSY_UIntAdd(v(1024)), v(1024));
EPILEPSY_ASSERT_EQ(EPILEPSY_UIntAdd(v(0) v(83)), v(83));
EPILEPSY_ASSERT_EQ(EPILEPSY_UIntAdd(v(15) v(8) v(4)), v(15 + 8 + 4));
EPILEPSY_ASSERT_EQ(EPILEPSY_UIntAdd(v(1) v(2) v(3) v(4) v(5)), v(1 + 2 + 3 + 4 + 5));
EPILEPSY_ASSERT_EQ(EPILEPSY_UIntAdd(v(0) v(1023)), v(1023));
*/
EPILEPSY_ASSERT_EQ(EPILEPSY_UIntAdd(v(0) v(1024)), v(1024));
