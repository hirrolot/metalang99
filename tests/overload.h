...
EPILEPSY_EVAL(call(X, v(1516) v(1) v(9) v(111) v(119) v(677) v(62)))
...
EPILEPSY_ASSERT_EQ(call(X, v(~)), v(27));
EPILEPSY_ASSERT_EQ(call(X, v(~) v(~)), v(12));
EPILEPSY_ASSERT_EQ(call(X, v(~) v(~) v(~)), v(0));
EPILEPSY_ASSERT_EQ(call(X, v(~) v(~) v(~) v(~) v(~) v(~) v(~) v(~)), v(7));
